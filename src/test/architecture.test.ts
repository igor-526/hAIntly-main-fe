...
describe("направленные зависимости", () => {
  ...
  it("отклоняет alias и relative обходы границ, прямой API из UI и внешний source", () => {
    const invalid: SourceFile[] = [
      { path: "src/ui/card.tsx", content: `import "@/${"features"}/auth/ui/auth-form"` },
      { path: "src/features/auth/ui/page.tsx", content: `import "@/${"features"}/workspace/home-page"` },
      { path: "src/ui/relative-card.tsx", content: `import "../${"features"}/auth/ui/auth-form"` },
      { path: "src/features/auth/ui/relative-page.tsx", content: `import "../../${"workspace"}/home-page"` },
      { path: "src/features/auth/ui/form.tsx", content: `import { apiRequest } from "@/${"api"}/main-be"` },
