import { beforeEach, describe,expect,it,vi } from "vitest";import { apiRequest } from "@/lib/api-client";import { authService } from "./service";vi.mock("@/lib/api-client",()=>({apiRequest:vi.fn()}));
